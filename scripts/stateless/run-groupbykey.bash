...
bin/kafka-topics.sh --delete --bootstrap-server localhost:9092 --topic counted
...
bin/kafka-topics.sh --create --bootstrap-server localhost:9092 --replication-factor 1 --partitions 2 --topic counted
popd

echo "Running Scala code"
cd ${DIR}/../..
sbt "runMain demo.kafka.transforms.stateless.groupbykey.Main"
