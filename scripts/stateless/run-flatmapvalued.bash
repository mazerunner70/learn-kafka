...
bin/kafka-topics.sh --delete --bootstrap-server localhost:9092 --topic unmapped
bin/kafka-topics.sh --delete --bootstrap-server localhost:9092 --topic mapped
...
bin/kafka-topics.sh --create --bootstrap-server localhost:9092 --replication-factor 1 --partitions 2 --topic unmapped
bin/kafka-topics.sh --create --bootstrap-server localhost:9092 --replication-factor 1 --partitions 2 --topic mapped
popd

echo "Running Scala code"
cd ${DIR}/../..
sbt "runMain demo.kafka.transforms.stateless.flatmapvalues.Main"
